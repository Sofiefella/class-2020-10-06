...
```{r}
scenario <-read_csv("data_538/election-forecasts-2020/presidential_scenario_analysis_2020.csv")
view(scenario)

national_toplines <- read_csv("data_538/election-forecasts-2020/presidential_national_toplines_2020.csv")
view(national_toplines)

ev_probs <- read_csv("data_538/election-forecasts-2020/presidential_ev_probabilities_2020.csv",
col_type = cols(
  cycle = col_double(),
...
ev_probs %>%
ggplot(ev_probs, mapping = aes(total_ev, evprob_chal)) +
  geom_col()
